...
/** @type {string} */
const CACHE_VERSION = '1781446395|102123350627';
/** @type {string} */
const CACHE_PREFIX = 'LudoOnline-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'LudoOnline.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["LudoOnline.html","LudoOnline.js","LudoOnline.offline.html","LudoOnline.audio.worklet.js","LudoOnline.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["LudoOnline.wasm","LudoOnline.pck"];
